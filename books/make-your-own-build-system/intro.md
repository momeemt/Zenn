...
| 11:00〜11:15 | [3. シンプルなビルドの実行](./simple-build) の解説 |
| 11:15〜11:45 | [3. シンプルなビルドの実行](./simple-build) の実装 |
| 11:45〜12:00 | [4. 依存関係を解決する](./resolve-deps) の解説 |
| 12:00〜12:30 | [4. 依存関係を解決する](./resolve-deps) の実装 |
| 12:30〜13:00 | [5. インクリメンタルビルド](./incremental-build) の解説と実装[^1] |

[^1]: 時間的な都合から、インクリメンタルビルドの実装までは完了しない可能性があります。
